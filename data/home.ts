...
export const hero = {
  ...
  /**
   * Столбик справа, как в макете. Каждый пункт ведёт на карточку
   * направления — id совпадает с /data/directions.ts.
   */
  marks: [
    { label: 'Твоя сила', target: 'gym' },
    { label: 'Твой ритм', target: 'personal' },
    { label: 'Твой результат', target: 'functional' },
  ],
  /** Какой пункт подсвечен, пока по столбику не водят мышью */
  defaultMark: 1,
